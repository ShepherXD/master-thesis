...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default='', help='specific checkpoint file to use')
    ...
    if args.checkpoint:
        checkpoint_one = args.checkpoint
        COMMAND = f'export PYTHONPATH=$PYTHONPATH:/home/kara/.local/lib/python3.8/site-packages:/usr/local/lib/python3.8/dist-packages && ' \
            f'python3.8 -m torch.distributed.launch --nproc_per_node=1 --master_port=12{random.randint(0,9)}{random.randint(0,9)}{random.randint(0,9)} --use_env /home/kara/DiffuSeq/sample_seq2seq.py ' \
