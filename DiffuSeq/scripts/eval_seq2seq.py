...
if __name__ == '__main__':
    ...
    parser.add_argument('--folder', type=str, default='/home/kara/DiffuSeq/generation_outputs/diffuseq_second-detox_h128_lr1e-05_t2000_sqrt_lossaware_seed102_learned_mask_fp16_denoise_0.5_reproduce20240721-19:15:12/ema_0.9999_035000.pt.samples', help='path to the folder of decoded texts')
