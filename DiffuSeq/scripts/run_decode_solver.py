...
if __name__ == '__main__':
    ...
    for lst in glob.glob(args.model_dir):
        ...
        for checkpoint_one in checkpoints:
            COMMAND = f'python3.8 -m torch.distributed.launch --nproc_per_node=1 --master_port=12{random.randint(0,9)}{random.randint(0,9)}{random.randint(0,9)} --use_env /home/kara/DiffuSeq/sample_seq2seq_dpmSolver.py ' \
